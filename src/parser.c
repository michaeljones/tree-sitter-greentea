...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2),
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2), SHIFT_REPEAT(40),
  [22] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2), SHIFT_REPEAT(59),
  [25] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2), SHIFT_REPEAT(27),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2), SHIFT_REPEAT(4),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_content, 1),
  [33] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_end_block, 3),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_loop, 3),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_end_block, 3),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_builder, 3),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 3),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 3),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_block, 8),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_block, 4),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__for_block, 6),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2), SHIFT_REPEAT(43),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 1),
  [60] = {.entry = {.count = 1, .reusable = false}}, SHIFT(43),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 2),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__headers, 1),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__headers, 2),
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__headers_repeat1, 2),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__headers_repeat1, 2), SHIFT_REPEAT(14),
  ...
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_with_statement, 5),
  ...
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 3, .production_id = 1),
  ...
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1),
